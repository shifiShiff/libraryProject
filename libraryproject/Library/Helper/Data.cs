...
namespace Library.Helper
{
    public static class Data
    {
        ...
        public static List<Subscribe> subscribers = new List<Subscribe>() { new Subscribe() {Id="214860728",Name="Shifi Shiff",Address="Yabrov 8",Phone="0527132865",IsActive=true,Age=8,NumOfBorrows=7 },
       ...
       new Subscribe() {Id="256415841",Name="Ruti Choen",Address="Desler",Phone="0586555465",IsActive=true,Age=12,NumOfBorrows=15 }};
        ...
        public static Book GetBookFromListByCode(int code)
        {
                return books.FirstOrDefault(b => b.Code == code);
        }
        public static Subscribe GetSubscribeFromListById(string id)
        {
            return subscribers.FirstOrDefault(s => s.Id == id);
        }
        public static Subscribe GetSubscribeFromListByName(string name)
        {
